...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            ConstantUserCode.UserCodeCollection.visitNonTKAllTPOSM();
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'PkComTradetracker.Validate_CameraScreen'.", repo.PkComTradetracker.Validate_CameraScreenInfo, new RecordItemIndex(7));
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'PkComTradetracker.ShopOpen_TakePictureButton2' at Center", repo.PkComTradetracker.ShopOpen_TakePictureButton2Info, new RecordItemIndex(10));
            repo.PkComTradetracker.ShopOpen_TakePictureButton2.Touch();
            Delay.Milliseconds(500);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'PkComTradetracker.Validate_CameraScreen'.", repo.PkComTradetracker.Validate_CameraScreenInfo, new RecordItemIndex(11));
            Validate.Exists(repo.PkComTradetracker.Validate_CameraScreenInfo);
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Touch", "Touch item 'PkComTradetracker.TPOSM_ButtonDone' at Center", repo.PkComTradetracker.TPOSM_ButtonDoneInfo, new RecordItemIndex(13));
            repo.PkComTradetracker.TPOSM_ButtonDone.Touch();
            Delay.Milliseconds(500);
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Non-TK') on item 'PkComTradetracker.Validate_NonTKShopScreen'.", repo.PkComTradetracker.Validate_NonTKShopScreenInfo, new RecordItemIndex(15));
