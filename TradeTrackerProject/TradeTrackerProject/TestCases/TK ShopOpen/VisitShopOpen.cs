...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>'TK') on item 'PkComTradetracker.Validate_TKShopScreen'.", repo.PkComTradetracker.Validate_TKShopScreenInfo, new RecordItemIndex(12));
            Validate.AttributeContains(repo.PkComTradetracker.Validate_TKShopScreenInfo, "Text", "TK");
            Delay.Milliseconds(0);
